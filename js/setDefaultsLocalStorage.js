...
if (!localStorage.getItem("theme") || !localStorage.getItem("showAirdata") || !localStorage.getItem("showMap") || !localStorage.getItem("showChart") || !localStorage.getItem("showVatsimData") || !localStorage.getItem("mapZoomLevel") || !localStorage.getItem("centerAircraft") || !localStorage.getItem("showUserMenu")) {
